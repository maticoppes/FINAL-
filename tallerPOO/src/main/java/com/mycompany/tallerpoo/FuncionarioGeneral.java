...
/**
 * Esta clase representa a un funcionario general que forma parte del personal del hospital.
 * Un funcionario general hereda atributos y métodos de la clase Persona y agrega información específica
 * relacionada con su rol, sector y contraseña.
 * 
 * @see Persona
...
public class FuncionarioGeneral extends Persona{       
     ...
     * @param telefonoCelular    El número de teléfono celular del funcionario general.
     * @param estadoCivil        El estado civil del funcionario general.
     * @param correoElectronico  La dirección de correo electrónico del funcionario general.
 ...
 */
    ...
    /**
     * Lee los datos de funcionarios generales desde un archivo ubicado en la ruta especificada.
     * 
     * @param ubicacion La ubicación o ruta del archivo que contiene los datos de funcionarios generales.
     * @return Una lista de objetos FuncionarioGeneral que representa a los funcionarios leídos desde el archivo.
     * @see LecturaDatosFuncionariosGenerales
     */    
