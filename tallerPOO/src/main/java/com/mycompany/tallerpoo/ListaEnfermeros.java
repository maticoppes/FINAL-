...
/**
 * La clase ListaEnfermeros es una colección que almacena instancias de la clase
 * Enfermero. Permite agregar enfermeros a la lista, así como leer y escribir
 * datos de enfermeros desde/hacia un archivo.
 *
 * @author Lucas
 */
public class ListaEnfermeros {
    ...
    /**
     * Constructor de la clase ListaEnfermeros que crea una lista vacía de
     * enfermeros.
     */
    ...
    /**
     * Lee información de enfermeros desde un archivo especificado y agrega los
     * enfermeros a la lista.
     *
     * @param archivoNombre El nombre del archivo del cual se leerá la
