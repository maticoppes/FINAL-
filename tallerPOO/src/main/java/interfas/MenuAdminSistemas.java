...
/**
 * Esta clase representa una interfaz que proporciona opciones de administración del sistema.
 * Los usuarios administradores del sistema pueden utilizar esta interfaz para realizar acciones específicas.
 * @author Matías
 */
public class MenuAdminSistemas extends javax.swing.JFrame {

    /**
     * Crea una nueva instancia de la clase `MenuAdminSistemas`.
     */
    ...
    private void initComponents() {
     ...
     /**
     * Maneja el evento cuando se hace clic en el botón "Información administrativa".
     * Abre la interfaz de información administrativa al presionar el botón "Información administrativa".
    ...
    /**
     * Maneja el evento cuando se hace clic en el botón "Registrar usuario".
     * Abre la interfaz de registro de usuario al presionar el botón "Registrar usuario".
     * @param evt El evento de acción del botón.
     */
    private void jButtonRegistarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistarUsuarioActionPerformed
        IngresoInfoFuncionario opcion1 = new IngresoInfoFuncionario();
